...
if($_POST){
    if(isset($_POST['name']) && !empty($_POST['name'])){
        ...
        $sq = "SELECT * FROM categories where name=:nam ";
        $que = $db->prepare($sq);
        $que->bindParam(':nam', $name, PDO::PARAM_STR);
        $que->execute();
        $cat = $que->fetch();
        if($cat)
        {
            $_SESSION['erreur'] = "La catégorie existe déjà";
            ...
            $query->bindParam(':parent', $_POST['select']);
...
<div class="mx-auto sm:ml-64">
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            <div class="container mx-auto">
                <h1 class="text-3xl font-bold mb-4 text-center">Ajouter une catégorie</h1>
